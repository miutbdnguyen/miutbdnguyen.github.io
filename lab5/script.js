...
console.log(
  "Expected output of max (10, 5) is 10 " + myFunctionTest(10, max(10, 5))
);
console.log(
  "Expected output of maxOfThree (10, 5, 70) is 70 " +
    myFunctionTest(70, maxOfThree(10, 5, 70))
);
console.log(
...
console.log(
  "Expected output of findLongestWord(['hello','hi', 'software']) is 8 " +
    myFunctionTest(8, findLongestWord(["hello", "hi", "software"]))
);
console.log(
  "Expected output of filterLongWords(['hello','hi', 'software']) is software " +
    myFunctionTest("software", filterLongWords(["hello", "hi", "software"], 5))
);
